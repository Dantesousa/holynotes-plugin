...
let overflowIconClass: string | null = null;
function getOverflowIcon(): string {
    if (overflowIconClass !== null) return overflowIconClass;
    try {
        const m = findByCode("overflowIcon");
        overflowIconClass = m?.overflowIcon ?? "";
    } catch {
        overflowIconClass = "";
    }
    return overflowIconClass;
}
                ...
                >
                    {props => (
                        <Button
                            ...
                            onClick={() => setShow(v => !v)}
                        >
                            <SvgOverFlowIcon className={classes(getOverflowIcon())} width={16} height={16}/>
                        </Button>
                    )}
                </Popout>
